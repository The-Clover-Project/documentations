...
Act 2: Source modifications without the consent of the core team is strictly not allowed and if found to do so, they shall removed from the team and a federation ban will be given against such maintainers.

Act 3: Maintainer cannot modify the download link.
